...
void ImGui_ImplVulkan_UpdateTexture(ImTextureData* tex)
{
    ...
    if (tex->Status == ImTextureStatus_WantCreate || tex->Status == ImTextureStatus_WantUpdates)
    {
        ...
        // End command buffer
        {
            ...
            // #modification
            v->mWorker.Dispatch(vk::SubmitInfo(end_info));
...
bool    ImGui_ImplVulkan_Init(ImGui_ImplVulkan_InitInfo* info)
{
    ...
    //IM_ASSERT(info->Queue != VK_NULL_HANDLE); // #modification
...
void ImGui_ImplVulkanH_CreateOrResizeWindow(VkInstance instance, VkPhysicalDevice physical_device, VkDevice device, ImGui_ImplVulkanH_Window* wd, uint32_t queue_family, const VkAllocationCallbacks* allocator, int width, int height, uint32_t min_image_count)
{
    ...
    v->mWorker.NextQueue()->Submit((vk::SubmitInfo)submit_info, fence);
...
static void ImGui_ImplVulkan_RenderWindow(ImGuiViewport* viewport, void*)
{
...

	{
		...
		}
		{
            ...
            // #modification
            v->mWorker.NextQueue()->Submit((vk::CommandBuffer)fd->CommandBuffer, (vk::Fence)fd->Fence);
        }
	}
}
...
static void ImGui_ImplVulkan_SwapBuffers(ImGuiViewport* viewport, void*)
{
    ...
    // #modification
    err = (VkResult)v->mWorker.NextQueue()->PresentKHR((vk::PresentInfoKHR)info);
